 ...
 */
class SendingThanksMailToClientTest extends TestCase
{
    ...
    public function shouldSendThanksMailToClient(): void
    {
        ...
        $sendedEmail = $this->bookingMailer->notifyReservationThanksEmailToClient('example@example.com', $reservationId);
